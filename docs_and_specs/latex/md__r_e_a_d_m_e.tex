...
\end{DoxyItemize}\hypertarget{md__r_e_a_d_m_e_autotoc_md2}{}\doxysection{Build}\label{md__r_e_a_d_m_e_autotoc_md2}
...
\hypertarget{md__r_e_a_d_m_e_autotoc_md4}{}\doxysubsection{Connect devices}\label{md__r_e_a_d_m_e_autotoc_md4}
...
\end{DoxyCode}
\hypertarget{md__r_e_a_d_m_e_autotoc_md5}{}\doxysubsection{Execute commands}\label{md__r_e_a_d_m_e_autotoc_md5}
\hypertarget{md__r_e_a_d_m_e_autotoc_md6}{}\doxysubsubsection{Use exec function to send SCPI commands.}\label{md__r_e_a_d_m_e_autotoc_md6}
...
\end{DoxyCode}
 \hypertarget{md__r_e_a_d_m_e_autotoc_md7}{}\doxysubsubsection{Use wrapped functions}\label{md__r_e_a_d_m_e_autotoc_md7}
...
\end{DoxyCode}
\hypertarget{md__r_e_a_d_m_e_autotoc_md8}{}\doxysection{Development}\label{md__r_e_a_d_m_e_autotoc_md8}
